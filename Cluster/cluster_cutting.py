...
from Cluster import read_info
from Cluster import GeoIniReader
from Cluster import read_CrystalInput
...
class ClusterCutter(object):
    ...
    def record_cluster(self):
        ...
        with open(self.record_file, 'w') as f:
            json.dump(data, f, indent=4)
        record_data_json(self.job.root_path, 'cutted cluster', geo_list, section='cluster')
