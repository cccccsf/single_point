...
import re
import os
from Components.get_e_configuration import count_num_of_shells
from Components.get_e_configuration import electron_config
...
def read_basis_set_file(element, bs_type):
    ...
    bs_path = os.path.join(bs_path, 'BasisSet')
